	...
	<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" readonly value="<?php echo $_SESSION["pelanggan"]['nm_pelanggan'] 
						?>" class="form-control">
					</div>
				</div>
				<div class="col-md-4">
		...
		if (isset($_POST["checkout"])) 
		{
			...
			$koneksi->query("INSERT INTO pembelian
				(id_pelanggan,id_ongkir,tgl_pembelian,total_pembelian,nm_kota,tarif,alamat_pengiriman)
				VALUES ('$id_pelanggan','$id_ongkir','$tanggal_pembelian','$total_pembelian','$nm_kota','$tarif',
				'$alamat_pengiriman')");
